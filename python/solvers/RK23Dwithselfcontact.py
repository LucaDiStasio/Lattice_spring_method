...
#         Output:
    ...
    vel1=vel + multiply(dot(0.5,dt),(Fel + Fdamp + Fext + Fselfcontact)) / m
    ...
    Fext=evaluateexternalforces3D(tn + dot(0.5,dt),lattice1,vel1,fexthandle)
    Fselfcontact=evaluateselfcontact3D(N,lattice1,boundary,Rcsq,ksc)
    lattice[:,7:9]=lattice[:,7:9] + multiply(dt,vel1)
    vel=vel + multiply(dt,(Fel + Fdamp + Fext + Fselfcontact)) / m
